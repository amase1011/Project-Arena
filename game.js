...
function drawChibi(x,y,type,side,attack,hit,walkPhase,scale=1,moving=false){
 ...
 const bob=moving?Math.abs(Math.sin(walkPhase))*1.8:Math.sin(performance.now()/420+x)*.5;
 ctx.translate(0,bob);
 ctx.fillStyle='#00000055';ctx.beginPath();ctx.ellipse(0,17,15,5,0,0,6.28);ctx.fill();
 if(hit)ctx.globalAlpha=.62;
 // legs
 ...
 function drawEquipment(k,dir,step){
  ...
  if(k==='shield'){
   const g=ctx.createLinearGradient(-18,-8,-5,13);g.addColorStop(0,'#a9c8ff');g.addColorStop(.45,'#5f86ca');g.addColorStop(1,'#294a83');ctx.fillStyle=g;ctx.beginPath();ctx.roundRect(-18,-5,13,22,4);ctx.fill();ctx.stroke();ctx.strokeStyle='#e9f2ff';ctx.beginPath();ctx.moveTo(7,-4);ctx.lineTo(14,15);ctx.stroke();
  }else if(k==='golem'){
   ctx.fillStyle='#66766a';ctx.beginPath();ctx.arc(0,-13,13,0,6.28);ctx.fill();ctx.fillStyle='#4d5a50';ctx.fillRect(-17,-1,8,20);ctx.fillRect(9,-1,8,20);ctx.strokeStyle='#9eae9e';ctx.strokeRect(-17,-1,8,20);ctx.strokeRect(9,-1,8,20);
  }else if(k==='knight'){
   const g=ctx.createLinearGradient(-10,-25,10,-4);g.addColorStop(0,'#fff');g.addColorStop(.5,'#b9cad8');g.addColorStop(1,'#66798b');ctx.fillStyle=g;ctx.beginPath();ctx.arc(0,-13,12,Math.PI,0);ctx.lineTo(12,-7);ctx.lineTo(-12,-7);ctx.closePath();ctx.fill();ctx.strokeStyle='#eac75c';ctx.lineWidth=4;ctx.beginPath();ctx.moveTo(7,-4);ctx.lineTo(15,15);ctx.stroke();
  }else if(k==='wolf'){
   const g=ctx.createLinearGradient(-15,-12,15,10);g.addColorStop(0,'#89939e');g.addColorStop(1,'#343b45');ctx.fillStyle=g;ctx.beginPath();ctx.ellipse(0,2,16,10,0,0,6.28);ctx.fill();ctx.beginPath();ctx.moveTo(-8,-17);ctx.lineTo(-6,-27);ctx.lineTo(-1,-18);ctx.moveTo(8,-17);ctx.lineTo(6,-27);ctx.lineTo(1,-18);ctx.fill();
  }else if(k==='assassin'){
   ctx.fillStyle='#25172f';ctx.beginPath();ctx.moveTo(0,-29);ctx.lineTo(15,-5);ctx.lineTo(-15,-5);ctx.closePath();ctx.fill();ctx.strokeStyle='#f4f5ff';ctx.lineWidth=4;ctx.beginPath();ctx.moveTo(-14,8);ctx.lineTo(14,-8);ctx.stroke();
  }else if(k==='archer'){
   ctx.strokeStyle='#75481f';ctx.lineWidth=4;ctx.beginPath();ctx.arc(10,2,13,-1.5,1.5);ctx.stroke();ctx.lineWidth=1.5;ctx.beginPath();ctx.moveTo(10,-11);ctx.lineTo(10,15);ctx.stroke();
  }else if(k==='ranger'){
   ctx.fillStyle='#355e39';ctx.beginPath();ctx.moveTo(0,-28);ctx.lineTo(13,-5);ctx.lineTo(-13,-5);ctx.closePath();ctx.fill();ctx.strokeStyle='#9b6b37';ctx.lineWidth=4;ctx.beginPath();ctx.arc(11,2,11,-1.5,1.5);ctx.stroke();
  }else if(k==='priest'){
   ctx.strokeStyle='#ff8fbd';ctx.lineWidth=4;ctx.beginPath();ctx.moveTo(11,-8);ctx.lineTo(11,16);ctx.moveTo(5,-1);ctx.lineTo(17,-1);ctx.stroke();ctx.fillStyle='#fff4a6';ctx.beginPath();ctx.arc(11,-10,4,0,6.28);ctx.fill();
  }else if(k==='bomber'){
   const g=ctx.createRadialGradient(7,-1,2,11,4,12);g.addColorStop(0,'#616a78');g.addColorStop(.45,'#202632');g.addColorStop(1,'#080a0f');ctx.fillStyle=g;ctx.beginPath();ctx.arc(11,4,10,0,6.28);ctx.fill();ctx.strokeStyle='#ffbd3d';ctx.beginPath();ctx.moveTo(14,-5);ctx.quadraticCurveTo(22,-15,23,-4);ctx.stroke();
  }
 }
}
